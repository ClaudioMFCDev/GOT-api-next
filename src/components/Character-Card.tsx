    ...
    <>
      ...
      >
        <div className=" group relative bg-black m-0 h-80 w-64 rounded-xl ring-gray-900/5 sm:mx-auto sm:max-w-lg">
          <div className=" shadow-xl shadow-black drop-shadow-sm z-10 h-full w-full overflow-hidden rounded-xl border border-gray-200 opacity-80 transition duration-300 ease-in-out group-hover:opacity-100 dark:border-gray-700 dark:opacity-70">
            <Image
