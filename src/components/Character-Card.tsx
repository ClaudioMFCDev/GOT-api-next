...
export const CharacterCard = ({character}: any) => {
    ...
    return (
        <>
            <div  key={character.id} onClick={() => { router.push(`/cardId/${character.id}`) }}>
                <div className="group relative bg-black m-0 h-72 w-72 rounded-xl ring-gray-900/5 sm:mx-auto sm:max-w-lg">
